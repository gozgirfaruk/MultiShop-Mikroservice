...
{
    public partial class migrationForCargo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CargoOperationies",
                columns: table => new
                {
                    CargoOperationsID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CargoOperationies", x => x.CargoOperationsID);
                });
